...
def test_admin_can_manage_courses_and_curriculum(client, admin_catalog_cleanup):
...
def test_admin_can_preview_and_confirm_excel_course_import(client, admin_catalog_cleanup):
