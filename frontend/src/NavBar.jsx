...
export default function NavBar(){
  ...
  return <header className="navbar ux-navbar"><a className="ux-skip" href="#main-content">ข้ามไปเนื้อหา</a><div className="navbar-inner">
    ...
    <nav className="nav-links" aria-label="เมนูหลัก"><NavLink to="/" end className="nav-link">รายวิชา</NavLink><NavLink to="/dashboard" className="nav-link">อันดับรายวิชา</NavLink><NavLink to="/plans" className="nav-link">แผนการเรียน</NavLink>{isAdmin&&<><NavLink to="/admin/dashboard" className="nav-link">ภาพรวมแอดมิน</NavLink><NavLink to="/admin" end className="nav-link">จัดการรายวิชา</NavLink></>}</nav>
